...
class MoneyFst(GraphFst):
    ...
    Finite state transducer for classifying money, e.g.
        ...
        "€1,001" -> money { currency_maj: "euro" integer_part: "un" fractional_part: "zero zero uno" }
        "£1,4" -> money { integer_part: "un" currency_maj: "libra" fractional_part: "cuarenta" preserve_order: true }
    ...
    def __init__(self, cardinal: GraphFst, decimal: GraphFst, deterministic: bool = True):
        ...
        graph_decimal_plural = pynini.union(
            ...
            # graph_decimal_final + pynini.closure(delete_space, 0, 1) + graph_maj_plural # 1,05$
        )
        ...
        graph_decimal_singular = pynini.union(
            ...
            # graph_decimal_final + pynini.closure(delete_space, 0, 1) + graph_maj_singular,  # 1,05$
        )
        ...
        graph_integer_only = pynini.union(
            ...
            # graph_integer_one + pynini.closure(delete_space, 0, 1) + graph_maj_singular,
        )
        graph_integer_only |= pynini.union(
            ...
            # graph_integer + pynini.closure(delete_space, 0, 1) + graph_maj_plural,
        )
