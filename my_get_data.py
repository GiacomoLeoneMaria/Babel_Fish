...
EXTRACTED_FOLDER = "la_contessa_di_karolystria"


def __process_transcript(file_path: str):
    # Create normalizer
    text_normalizer = Normalizer(
        lang="en", input_case="cased", overwrite_cache=True, cache_dir=str(file_path / "cache_dir"),
    )
    # text_normalizer = Normalizer(
    #     lang="it", input_case="cased", overwrite_cache=True, cache_dir=str(file_path / "cache_dir"),
    # )
